      ...
      >
        <div className="flex items-center justify-between pb-4 border-b border-neutral-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-400">Send an invitation email to join your team</p>
            </div>
          </div>
          <button
            type="button"
        ...
        {sentLink ? (
          ...
          <div className="mt-6 space-y-5 text-center">
            <div className="w-12 h-12 rounded-2xl bg-emerald-950/50 border border-emerald-800/60 text-emerald-400 flex items-center justify-center mx-auto shadow-md">
              <Sparkles className="w-6 h-6" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-white">Invitation Sent!</h3>
              <p className="text-xs text-neutral-400 mt-1 max-w-xs mx-auto">
                An email was sent to <strong className="text-white">{email}</strong> congratulating them on joining as <strong className="text-white">{role}</strong> with their setup link.
              </p>
            </div>

            <div className="p-3.5 rounded-2xl bg-neutral-950 border border-neutral-800 text-left space-y-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  readOnly
                  value={sentLink}
                  className="w-full text-xs font-mono bg-neutral-900 border border-neutral-800 rounded-lg px-2.5 py-1.5 text-neutral-300 focus:outline-none"
                />
                <button
                  type="button"
                  onClick={handleCopyLink}
                  className="px-3 py-1.5 rounded-lg bg-white text-black text-xs font-semibold hover:bg-neutral-200 transition flex items-center gap-1 flex-shrink-0 cursor-pointer"
                >
            ...
            <div className="pt-3 border-t border-neutral-800">
              <button
                type="button"
                onClick={onClose}
                className="w-full py-2.5 bg-white text-black text-xs font-semibold rounded-xl hover:bg-neutral-200 transition cursor-pointer"
              >
                Done
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              ...
              <div className="flex items-center justify-end gap-2 pt-4 border-t border-neutral-800">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 py-2 text-xs font-semibold text-black bg-white hover:bg-neutral-200 rounded-xl transition disabled:opacity-50 shadow-sm flex items-center gap-1.5 cursor-pointer"
                >
